...
if ($rga) {
    while ($fga = $rga->fetch_assoc()) {
        ...
        $oga .=     '<td><a href="'.$ruta_inicio.'asignar-tallas-articulo.php?id_articulo='.$fga['id_articulo'].'">';
        $oga .=         '<button type="button" class="btn btn-outline-info">Stock - Asignar</button>';
        $oga .=     '</a></td>';
