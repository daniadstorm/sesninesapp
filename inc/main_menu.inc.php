    ...
    switch ($_SESSION['id_tipo_usuario']) {
        case ADMIN:
            $arrMnu = array(
                ...
                7=>array('ttl'=>'Analytics', 'dest'=>'analytics.php', 'img'=>'', 'class'=>'opt_menu'),
                8=>array('ttl'=>'Mails', 'dest'=>'mails.php', 'img'=>'', 'class'=>'opt_menu'),
                9=>array('ttl'=>'Cerrar sesión', 'dest'=>$ruta_inicio.'login.php?unlogin=true', 'img'=>$ruta_inicio.'img/cerrar.png', 'class'=>'opt_menu'),
            );
        break;
        case USER:
            $arrMnu = array(
